const th = {
  ...
  shift: {
    ...
    shiftAlreadyActive: 'มีกะการทำงานที่ยังเปิดใช้งานอยู่',
    shiftAlreadyActiveWarning: 'มีกะการทำงานของเครื่องนี้เปิดใช้งานอยู่ในระบบฐานข้อมูล กรุณากระทบยอดและปิดกะปัจจุบันก่อนเปิดกะใหม่',
  },
  ...
  settings: {
    ...
    quickPrint: 'พิมพ์ด่วนส่งตรงไปยังเครื่องพิมพ์ (Quick Print)',
    quickPrintDesc: 'ข้ามหน้าต่างดูตัวอย่าง (Preview Modal) เพื่อการปิดบิลที่รวดเร็วยิ่งขึ้น ส่งคำสั่งตรงเข้าเครื่องพิมพ์ทันที',
    quickPrintBypass: 'ข้ามหน้าต่างตัวอย่าง',
  ...
  syncLatency: {
    title: 'ความหน่วงการซิงก์แบบเรียลไทม์',
    footerLabel: 'SYNC LATENCY',
    rtt: 'เวลาส่ง-รับข้อมูล (RTT)',
    statusOptimal: 'ดีเยี่ยม (ต่ำกว่า 100ms)',
    statusGood: 'ดี (100-250ms)',
    statusModerate: 'ปานกลาง (250-500ms)',
    statusHigh: 'สูง (500-1000ms)',
    statusPoor: 'วิกฤต (> 1000ms)',
    statusOffline: 'ออฟไลน์ / ไม่สามารถเชื่อมต่อได้',
    cloudDb: 'ฐานข้อมูลคลาวด์',
    cloudDbConnected: 'Cloud PostgreSQL / Firestore เชื่อมต่อแล้ว',
    localOps: 'การทำงานเครื่องลูกข่าย (Local)',
    roundTripSummary: 'รอบการประมวลผลคำสั่งระหว่างเครื่องลูกข่ายและคลาวด์',
    lastCycle: 'รอบการซิงก์ล่าสุด',
    avgLatency: 'ค่าเฉลี่ย RTT',
    minLatency: 'ต่ำสุด',
    maxLatency: 'สูงสุด',
    pingNow: 'ทดสอบ RTT ทันที',
    breakdownTitle: 'โครงสร้างเวลาการตอบสนอง (RTT Breakdown)',
    localDb: 'บันทึกลง IndexedDB ภายในเครื่อง',
    network: 'ความหน่วงของเครือข่าย & คลาวด์เกตเวย์',
    cloudAck: 'การยืนยันบันทึกธุรกรรมลงฐานข้อมูลคลาวด์',
    syncHistory: 'ประวัติความหน่วงของรอบการซิงก์ล่าสุด',
    simulatePreset: 'จำลองความเร็วเครือข่าย',
    fastPreset: 'LAN/ใยแก้วนำแสง (20ms)',
    mobile4gPreset: '4G LTE (150ms)',
    mobile3gPreset: '3G พื้นที่ห่างไกล (450ms)',
    satellitePreset: 'ดาวเทียม / เครือข่ายหน่วงสูง (900ms)',
    offlineToggle: 'ตัดการเชื่อมต่อจำลอง (Offline)',
  },
};

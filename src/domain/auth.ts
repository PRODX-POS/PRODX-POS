...
export const DEFAULT_STAFF_PASSWORDS: Record<string, string> = {
  'usr-admin-alex': 'Admin@Prodx2026!',
  'usr-manager-sarah': 'Sarah#Manager2026',
  'usr-cashier-john': 'Cashier*John2026',
  'usr-cashier-emily': 'Emily#Cashier2026',
};
...
export function saveStoredStaffPasswords(passwords: Record<string, string>): void {
  try {
    ...
    console.error('Failed to save staff passwords to storage', e);
  }
}
